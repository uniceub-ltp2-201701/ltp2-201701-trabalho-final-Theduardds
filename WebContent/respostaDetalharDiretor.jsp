...
<html>
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/styles/respostaDetalharDiretor.css" />
<link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
<title>Detalhar Diretor</title>
</head>
<body>
...
<%  Diretor d = (Diretor) request.getAttribute("diretor");
	...
	<div class="container" style="width: 250px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);color:white; float: right; padding: 15px; border:1px solid #c62828;background-color: #c62828; height: auto; width: 150px; text-align: center; word-wrap: break-word; text-overflow: ellipsis;">
			<a href="/SistemaFilmes/paginaEditarDiretor?iddiretor=<%out.println(d.getIdDiretor());%>" style="color:white;">Editar Diretor</a>
		</div>
	...
	<tr><th>Nome</th></tr>
	<tr><td><%out.println(d.getNome());%></td></tr>
	</table>
	
	<% int idade = 2017 - (1900+d.getData_nasc().getYear()) ; %>
	
	<table border="1" style="font-size:18px; float:left; margin-left:15px;">
	<tr><th>Nascimento</th><th>Idade</th></tr>
	<tr><td><%out.println(d.getData_nasc()); %></td>
	<td><%out.println(idade);%></td>
	</tr>	
	</table>
	<br><br><br><br>
	
	<% out.println("<img src='" + d.getUrl() + "' alt=Image not available/>"); %><br><br>
	
	<table border="1" style="float:left; margin-left:250px; font-size:15px">
	...
	<table border="1" style="float:left;margin-left:15px; font-size:15px">
...
<td width="200px" height="50px"><% out.println("<a href='/SistemaFilmes/detalharFilme?idfilme=" + f.get(i).getIdFilme() + "&mensagem='>" + f.get(i).getTitulo() + "</a>"); %></td>
</tr>
<%}%>
</table>
