...
<html>
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/styles/respostaPaginaAdicionarAtor.css" />
...
<h1 style="text-align:center;">Adicionar ator</h1>
...
<div id="local">
  <form action="adicionarAtor" style="height:auto" method="post">
    ...
    <input type="text" id="nascimento" name="nascimento" placeholder="Data de nascimento do ator..." style="width:250px"><br>
