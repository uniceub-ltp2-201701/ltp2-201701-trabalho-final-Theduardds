...
<body>
	...
	<form action="listarFilmesPontuacao" method="get" style="margin-right:300px;">
		 ...
		 <input type="text" id="pontuacao" name="pontuacao" placeholder="Pontuação..." style="width:120px; float:right; padding: 5px 10px;margin: 8px 0;display: inline-block;border: 1px solid #ccc;box-sizing: border-box;height:30px;">
		 <select id="simbolo" name="simbolo" style="float:right;display: inline-block;border: 1px solid #ccc;height:30px; box-sizing: border-box; padding:0px 0px;">
			<option value="&lt;">&lt;</option>
		 <option value="&gt;">&gt;</option>
	</select>
	</form>
...
<%if(filmes.isEmpty()){%>
	...
	<h1 style="margin-left:450px; margin-top:200px; margin-right:100px;font-size:30px">Verifique se o banco de dados está aberto ou se senha do mysql está correta.</h1>
