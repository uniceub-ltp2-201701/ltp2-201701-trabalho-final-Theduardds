...
<html>
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/styles/respostaListarDiretores.css" />
...
<%if(!(u==null) && u.getPrivilegio()==1){ %>
	...
	<div class="container" style="width: 250px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);color:white; float: right; padding: 15px; border:1px solid #c62828;background-color: #c62828; height: auto; width: 150px; text-align: center; word-wrap: break-word; text-overflow: ellipsis;">
			<a href="/SistemaFilmes/paginaAdicionarDiretor" style="color:white;">Adicionar diretor</a>
		</div>
...
<h1><i class="material-icons" style="font-size:23px;">record_voice_over</i>Diretores</h1>
...
if(i>3){%>
				...
				<div class="polaroid" style="margin-left: 250px;">
					...
					<% out.println("<a href='/SistemaFilmes/detalharDiretor?iddiretor=" + diretores.get(i).getIdDiretor() + "'><img src='" + diretores.get(i).getUrl() + "' alt='Image not available'/></a>"); %>
				<div class="container">
					<% out.println("<p><a href='/SistemaFilmes/detalharDiretor?iddiretor=" + diretores.get(i).getIdDiretor() + "'>" + diretores.get(i).getNome() + "</a></p>"); %>
